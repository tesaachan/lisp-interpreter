...
class RecursiveLanguageSuite {
  ...
  @Test def foldLeft: Unit = {
    ...
    assertEquals(C(106), eval(call1, defs + sum))
    ...
    assertEquals(C(138), eval(call2, defs + div))
  }
  ...
  @Test def foldRight: Unit = {
    ...
    assertEquals(C(3003), eval(call2, defs + div))
  }
  ...
  @Test def substitutionFunctionCapture: Unit = {
    ...
    assertEquals(list2, eval(Call(Call(N("map"), list1), N("plus_one")), defs + plus_one))
  }
  ...
  @Test def substitutionMatchCapture: Unit = {
    ...
    assertEquals(Cons(C(6), C(24)), eval(Call(Call(N("pairMap"), Cons(C(3), C(4))), N("fact")), defs + pairMap))
  }
